...
###############################################################################
# Modelo MLP de 1 entrada, 1 capa oculta con 2 neuronas (arctan) y 1 salida
###############################################################################
...
slider_v1 = Slider( 50, 690, 200, 20, -50, 50, v1, label="v1")
slider_v2 = Slider(300, 690, 200, 20, -50, 50, v2, label="v2")
slider_c  = Slider( 50, 720, 200, 20, -50, 50, c, label="c")
slider_lr = Slider(300, 720, 200, 20, 0.000001, 0.0001, 0.00001, label="Learning Rate")

# Cuadros de texto para configurar steps por segundo y número de puntos
textbox_steps = TextBox(50, 760, 100, 40, text="100")
textbox_n_points = TextBox(300, 760, 100, 40, text="100")
